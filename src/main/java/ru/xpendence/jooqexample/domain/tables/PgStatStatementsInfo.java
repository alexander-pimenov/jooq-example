...
import ru.xpendence.jooqexample.domain.tables.records.PgStatStatementsInfoRecord;
...
public class PgStatStatementsInfo extends TableImpl<PgStatStatementsInfoRecord> {
    ...
    /**
     * The reference instance of <code>public.pg_stat_statements_info</code>
     */
    ...
    /**
     * The column <code>public.pg_stat_statements_info.dealloc</code>.
     */
    public final TableField<PgStatStatementsInfoRecord, Long> DEALLOC = createField(DSL.name("dealloc"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.pg_stat_statements_info.stats_reset</code>.
     */
    ...
    /**
     * Create an aliased <code>public.pg_stat_statements_info</code> table
     * reference
     */
    ...
    /**
     * Create a <code>public.pg_stat_statements_info</code> table reference
     */
